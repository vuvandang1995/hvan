...
class UserForm(forms.Form):
    ...
    def clean_username(self):
        ...
        if get_username(username) is not None:
    ...
    def clean_email(self):
        ...
        if get_email(email) is not None:
    ...
    # lưu tài khoản User
    def save(self):
        u = MyUser.objects.create_student(fullname=self.cleaned_data['fullname'], username=self.cleaned_data['username'],
